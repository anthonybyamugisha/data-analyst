              ...
              <div className="glass rounded-xl p-6 border border-border hover:shadow-hover transition-all duration-500 transform hover:-translate-y-1 relative z-10">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="https://www.simplilearn.com/skillup-certificate-landing?token=eyJjb3Vyc2VfaWQiOiI1MDY3IiwiY2VydGlmaWNhdGVfdXJsIjoiaHR0cHM6XC9cL2NlcnRpZmljYXRlcy5zaW1wbGljZG4ubmV0XC9zaGFyZVwvODk2ODk0MV85MTgzMTU5MTc1Nzc0ODIxMjM1Mi5wbmciLCJ1c2VybmFtZSI6IkJZQU1VR0lTSEEgQU5USE9OWSJ9&utm_source=shared-certificate&utm_medium=app_lms&utm_campaign=shared-certificate-promotion&referrer=https%3A%2F%2Fcertificates.simplicdn.net%2Fshare%2F8968941_91831591757748212352.png&_branch_match_id=1538211553728235462&_branch_referrer=H4sIAAAAAAAAA8soKSkottLXL87MLcjJ1EssKNDLyczL1jeMDHK2MDT2cA5Psq8rSk1LLSrKzEuPTyrKLy9OLbL1AapJTfHMAwAzEo8vPwAAAA%3D%3D" target="_blank" rel="noopener noreferrer" className="text-sm text-primary hover:underline font-medium">Show Credential</a>
                  </div>
                </div>
              </div>
            </div>
